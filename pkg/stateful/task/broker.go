...
type Broker interface {
	CreateInstance(instanceId string, parameters json.RawMessage) (ExecutionState, json.RawMessage, error)
	UpdateInstance(instanceId string, parameters json.RawMessage) (ExecutionState, json.RawMessage, error)
	DeleteInstance(instanceId string, parameters json.RawMessage) (ExecutionState, error)
